    ...
    <div className='bg-slate-50 w-screen h-screen'>
        <div className='w-screen flex mb-6'>
            ...
            <div className='mt-[4rem] ml-4'>
                <Button  onClick={CloseShareit} Variant='secondary' FrontIcon={<ShareIcon Sizes='md'/>} Size='lg' Text='Share Brain'></Button>
            </div>
        ...
        <div className='flex pl-[22rem] pt-6 flex-wrap'>
          {Content.map(({links , type , title , _id}) => <Card TopHead={title} Type={type} Link={links} Id={_id} CardType={"normal"}/>)}
        </div>
    </div>
    </div>
  </>
